...
function GlobalChatWidget({
  ...
  const prevHiddenRef = react.useRef(true);
  ...
  const fetchConvs = react.useCallback(() => {
  ...
  const widget = /* @__PURE__ */ React.createElement("div", { className: "fixed bottom-4 right-4 z-50 flex flex-col items-end gap-2" }, open && /* @__PURE__ */ React.createElement("div", { className: "w-80 bg-white rounded-xl shadow-2xl border flex flex-col overflow-hidden", style: { height: "420px" } }, /* @__PURE__ */ React.createElement("div", { className: "px-3 py-2.5 bg-blue-700 text-white flex items-center justify-between shrink-0" }, activeConvId ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1.5 min-w-0" }, /* @__PURE__ */ React.createElement("button", { onClick: backToList, className: "hover:text-blue-200 shrink-0" }, /* @__PURE__ */ React.createElement(lucideReact.ArrowLeft, { size: 14 })), /* @__PURE__ */ React.createElement(
  ...
  }, className: "hover:text-blue-200 shrink-0 ml-1" }, /* @__PURE__ */ React.createElement(lucideReact.X, { size: 15 }))) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { className: "text-sm font-medium" }, "\u79C1\u4EBA\u8A0A\u606F"), /* @__PURE__ */ React.createElement("button", { onClick: () => {
    setOpen(false);
    dismissedRef.current = true;
  }, className: "hover:text-blue-200" }, /* @__PURE__ */ React.createElement(lucideReact.X, { size: 15 })))), !activeConvId && /* @__PURE__ */ React.createElement("div", { className: "flex-1 overflow-y-auto divide-y divide-gray-100" }, convs.length === 0 && /* @__PURE__ */ React.createElement("p", { className: "text-center text-sm text-gray-400 py-10" }, "\u5C1A\u7121\u5C0D\u8A71"), convs.map((conv) => /* @__PURE__ */ React.createElement(
    "button",
    {
      key: conv.id,
    ...
    return /* @__PURE__ */ React.createElement("div", { key: msg.id, className: `group flex flex-col ${isMine ? "items-end" : "items-start"}` }, /* @__PURE__ */ React.createElement("div", { className: `flex items-end gap-1 ${isMine ? "flex-row-reverse" : "flex-row"}` }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(lucideReact.Reply, { size: 12 })
      ...
      /* @__PURE__ */ React.createElement(lucideReact.FileText, { size: 12 }),
    ...
    /* @__PURE__ */ React.createElement(lucideReact.Send, { size: 14 })
  )))), /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => {
    ...
    /* @__PURE__ */ React.createElement(lucideReact.MessageCircle, { size: 22 }),
