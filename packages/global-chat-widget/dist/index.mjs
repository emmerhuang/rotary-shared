...
function GlobalChatWidget({
  ...
  const lightbox = lightboxUrl ? createPortal(
    /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-[200] bg-black/80 flex items-center justify-center", onClick: () => setLightboxUrl(null), children: [
      /* @__PURE__ */ jsx("button", { className: "absolute top-4 right-4 text-white hover:text-gray-300", children: /* @__PURE__ */ jsx(X, { size: 28 }) }),
      /* @__PURE__ */ jsx("img", { src: lightboxUrl, alt: "\u5168\u5716", className: "max-w-[90vw] max-h-[90vh] object-contain rounded-lg shadow-2xl", onClick: (e) => e.stopPropagation() })
    ] }),
    document.body
  ) : null;
  const widget = /* @__PURE__ */ jsxs("div", { className: "fixed bottom-4 right-4 z-50 flex flex-col items-end gap-2", children: [
    open && /* @__PURE__ */ jsxs("div", { className: "w-80 bg-white rounded-xl shadow-2xl border flex flex-col overflow-hidden", style: { height: "420px" }, children: [
      /* @__PURE__ */ jsx("div", { className: "px-3 py-2.5 bg-blue-700 text-white flex items-center justify-between shrink-0", children: activeConvId ? /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 min-w-0", children: [
          /* @__PURE__ */ jsx("button", { onClick: backToList, className: "hover:text-blue-200 shrink-0", children: /* @__PURE__ */ jsx(ArrowLeft, { size: 14 }) }),
          /* @__PURE__ */ jsx(
            "button",
            {
              onClick: () => {
              ...
              children: /* @__PURE__ */ jsx("span", { className: "text-sm font-medium truncate", children: activeConv?.other.rotaryClubName ?? "" })
            }
          )
        ] }),
          ...
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "relative shrink-0", children: [
                /* @__PURE__ */ jsx("div", { className: "w-9 h-9 rounded-full bg-blue-200 flex items-center justify-center text-blue-800 font-semibold text-sm", children: conv.other.rotaryClubName.slice(0, 1) }),
                isOnline(conv.other.lastSeenAt) && /* @__PURE__ */ jsx("span", { className: "absolute bottom-0 right-0 w-2.5 h-2.5 bg-green-500 rounded-full border-2 border-white" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-gray-900 truncate", children: conv.other.rotaryClubName }),
                  conv.latestMessage?.createdAt && /* @__PURE__ */ jsx("span", { className: "text-[10px] text-gray-400 shrink-0 ml-1", children: formatDistanceToNow(/* @__PURE__ */ new Date(conv.latestMessage.createdAt.replace(" ", "T") + "Z"), { locale: zhTW, addSuffix: true }) })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mt-0.5", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-xs text-gray-500 truncate", children: conv.latestMessage?.content ?? "\u5C1A\u7121\u8A0A\u606F" }),
                  conv.unreadCount > 0 && /* @__PURE__ */ jsx("span", { className: "ml-1 shrink-0 bg-red-500 text-white text-[10px] font-bold rounded-full min-w-[16px] h-4 flex items-center justify-center px-1", children: conv.unreadCount > 99 ? "99+" : conv.unreadCount })
                ] })
              ] })
            ]
          },
      ...
      activeConvId && /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs("div", { ref: scrollContainerRef, onScroll: handleScroll, className: "flex-1 overflow-y-auto px-3 py-2 space-y-2 bg-gray-50", children: [
          msgs.length === 0 && /* @__PURE__ */ jsx("p", { className: "text-center text-xs text-gray-400 py-6", children: "\u958B\u59CB\u50B3\u9001\u7B2C\u4E00\u5247\u8A0A\u606F\u5427\uFF01" }),
          msgs.map((msg) => {
            const isMine = activeConv ? msg.senderId !== activeConv.other.id : false;
            return /* @__PURE__ */ jsxs("div", { className: `group flex flex-col ${isMine ? "items-end" : "items-start"}`, children: [
              /* @__PURE__ */ jsxs("div", { className: `flex items-end gap-1 ${isMine ? "flex-row-reverse" : "flex-row"}`, children: [
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    onClick: () => {
                ...
                /* @__PURE__ */ jsxs("div", { className: `max-w-[80%] px-2.5 py-1.5 rounded-xl text-sm ${isMine ? "bg-blue-600 text-white" : "bg-white shadow-sm text-gray-900"}`, children: [
                  msg.replyToContent != null && /* @__PURE__ */ jsxs("div", { className: `mb-1 px-1.5 py-1 rounded text-xs border-l-2 ${isMine ? "border-blue-300 bg-blue-500 text-blue-100" : "border-gray-300 bg-gray-100 text-gray-500"}`, children: [
                    /* @__PURE__ */ jsx("p", { className: "font-medium", children: msg.replyToSenderName }),
                    /* @__PURE__ */ jsx("p", { className: "truncate", children: msg.replyToContent || "\u9644\u4EF6" })
                  ] }),
                  msg.content && (() => {
                    const sm = getStickerMatch(msg.content);
                    return sm ? /* @__PURE__ */ jsx("img", { src: stickerUrl(sm.id), alt: sm.emoji, className: "w-14 h-14" }) : /* @__PURE__ */ jsx("p", { className: "whitespace-pre-wrap break-words", children: msg.content });
                  })(),
                  msg.attachmentUrl ? msg.attachmentType?.startsWith("image/") ? /* @__PURE__ */ jsx("button", { onClick: () => setLightboxUrl(msg.attachmentUrl), className: "mt-1 block", children: /* @__PURE__ */ jsx("img", { src: msg.attachmentUrl, alt: msg.attachmentName ?? "\u5716\u7247", className: "max-w-[160px] max-h-[160px] rounded-lg object-cover cursor-zoom-in hover:opacity-90 transition-opacity" }) }) : /* @__PURE__ */ jsxs(
                    "a",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsx("span", { className: "truncate max-w-[120px]", children: msg.attachmentName ?? "\u9644\u4EF6" })
                      ]
                    }
                  ) : !msg.content && msg.replyToContent == null && /* @__PURE__ */ jsx("p", { className: "text-xs opacity-60", children: "\u9644\u4EF6\u5DF2\u904E\u671F" })
                ] })
              ] }),
              isMine && msg.readAt && /* @__PURE__ */ jsx("span", { className: "text-[10px] text-gray-400 mt-0.5 px-1", children: "\u5DF2\u8B80" })
            ] }, msg.id);
          }),
          /* @__PURE__ */ jsx("div", { ref: bottomRef })
        ] }),
        replyTo && /* @__PURE__ */ jsxs("div", { className: "px-2 py-1.5 bg-blue-50 border-t flex items-center gap-2 text-xs shrink-0", children: [
          /* @__PURE__ */ jsx(Reply, { size: 11, className: "text-blue-500 shrink-0" }),
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsx("p", { className: "text-blue-600 font-medium", children: replyTo.replyToSenderName ?? (activeConv && replyTo.senderId === activeConv.other.id ? activeConv.other.contactName : "\u4F60") }),
            /* @__PURE__ */ jsx("p", { className: "text-gray-500 truncate", children: replyTo.content || replyTo.attachmentName || "\u9644\u4EF6" })
          ] }),
          /* @__PURE__ */ jsx("button", { onClick: () => setReplyTo(null), className: "hover:text-red-500 shrink-0", children: /* @__PURE__ */ jsx(X, { size: 11 }) })
        ] }),
        pendingFile && /* @__PURE__ */ jsx("div", { className: "px-2 py-1.5 bg-blue-50 border-t shrink-0", children: previewUrl ? /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsx("img", { src: previewUrl, alt: "\u9810\u89BD", className: "max-h-[80px] max-w-[120px] rounded-lg object-cover border border-blue-200" }),
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0 mt-0.5", children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs text-blue-700 truncate", children: pendingFile.name }),
            /* @__PURE__ */ jsx("p", { className: "text-[10px] text-blue-400 mt-0.5", children: "\u6309\u9001\u51FA\u9375\u4E0A\u50B3" })
          ] }),
          /* @__PURE__ */ jsx("button", { onClick: () => setPendingFile(null), className: "shrink-0 text-gray-400 hover:text-red-500", children: /* @__PURE__ */ jsx(X, { size: 12 }) })
        ] }) : /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-xs text-blue-700", children: [
          /* @__PURE__ */ jsx(FileText, { size: 12 }),
          /* @__PURE__ */ jsx("span", { className: "flex-1 truncate", children: pendingFile.name }),
          /* @__PURE__ */ jsx("button", { onClick: () => setPendingFile(null), className: "hover:text-red-500", children: /* @__PURE__ */ jsx(X, { size: 12 }) })
        ] }) }),
        uploadError && /* @__PURE__ */ jsxs("div", { className: "px-2 py-1.5 bg-red-50 border-t flex items-center gap-1.5 text-xs text-red-600 shrink-0", children: [
          /* @__PURE__ */ jsx("span", { className: "flex-1", children: uploadError }),
          /* @__PURE__ */ jsx("button", { onClick: () => setUploadError(null), className: "hover:text-red-800", children: /* @__PURE__ */ jsx(X, { size: 11 }) })
        ] }),
    ...
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          ...
          unread > 0 && /* @__PURE__ */ jsx("span", { className: "absolute -top-1 -right-1 bg-red-500 text-white text-[10px] font-bold rounded-full min-w-[18px] h-[18px] flex items-center justify-center px-1 leading-none", children: unread > 99 ? "99+" : unread })
        ]
      }
    )
  ] });
